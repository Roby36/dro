...
export PATH='/opt/ros/melodic/bin:/usr/lib/ccache:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/root/catkin_ws/ardupilot_ws/src/ardupilot/Tools/autotest:/root/.local/bin:/root/.local/bin'
